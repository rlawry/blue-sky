...
var particleSystem=new ParticlesSystem(100,{x:canWidth*0.1,y:canHeight*0.5},0.2,0.5,190,170);
var y = 0;
...
function draw(){
    ...
    lastTime=new Date();
    y = 45*Math.sin(lastTime/100) + 90*Math.sin(lastTime/110);
...
function drawSun(y){
    cc.save();
    cc.fillStyle = "yellow";
    cc.translate(can.width*0.1-25,can.height*0.5-25+y);
    cc.fill(path1);
    cc.fill(path2);
    cc.fill(path3);
    cc.fill(path4);
